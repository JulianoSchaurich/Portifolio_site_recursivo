...
$texto_upgrade = $_SESSION['texto_upgrade'];
$link_upgrade = $_SESSION['link_upgrade'];
?>
...
<div class="mt-5 container-fluid w-75">
    <div class="mt-5  w-25 ">
        <form method="post" action="manipula_objetos.php">
            ...
            <p><input type="text" name="txt_texto" value="<?=$texto_upgrade?>" class="form-control"></p>

            <label for="" class="form-label"><h5>Link</h5> </label>
            <p><input type="text" name="txt_link" value="<?=$link_upgrade?>" class="form-control"></p>
